...
function showToast(message) {
  ...
  var styles = [
    ...
    'background:#0F1A30', 'border:1px solid #C9A84C',
    'border-left:4px solid #C9A84C', 'color:#F0F4FF',
  ...
  toast.innerHTML = '<i class="bi bi-check-circle-fill" style="color:#C9A84C;font-size:1.1rem;flex-shrink:0;"></i><span>' + message + '</span>';
...
with open('templates/bookings/new.html', 'w', encoding='utf-8', newline='\n') as f:
    f.write(content)
print('New booking template with toast notification written successfully')
